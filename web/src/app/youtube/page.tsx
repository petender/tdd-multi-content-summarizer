        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mb-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-yellow-800">Local Use Only</h3>
                <p className="mt-1 text-sm text-yellow-700">
                  YouTube transcript fetching works when running locally but may fail when deployed to Azure due to IP restrictions. 
                  Consider using the Text Input option to paste YouTube transcripts manually.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Enter a YouTube URL to get an AI-powered summary in your preferred language
            </p>
          </div>
